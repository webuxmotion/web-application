                ...
                <div class="col text-end icons">
                    <form>
                        <div class="input-group" id="search">
                            <input type="text" class="form-control" placeholder="<?=__('layout_search')?>..." name="s">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"><?=__('layout_login')?></a></li>
                            <li><a class="dropdown-item" href="#"><?=__('layout_registration')?></a></li>
                        </ul>
                    </div>
        ...
        <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid p-0">
                    <a class="navbar-brand" href="<?=baseUrl()?>">Shop Brand</a>
